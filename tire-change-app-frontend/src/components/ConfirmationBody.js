    ...
    <Modal.Body className='pt-0 ps-0 ms-2'>
      <div className='ps-0'>
        ...
        <ul className='ps-0 py-0 mb-0 text-muted'>
          <li>Time: <span className='fw-bolder'>{response.time}</span></li> <li>Address: <span className='fw-bolder'>{response.address}</span></li>{' '}
          <li>Vehicle Type: <span className='fw-bolder'>{response.vehicleType}</span></li>
        </ul>
